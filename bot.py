...
@codexmania.on(events.callbackquery.CallbackQuery(data=re.compile(b"unmute_(.*)")))
async def _(event):
...
async def strt(event):
    await event.reply(f"Hi. I'm a force subscribe bot made by @{channel}!\n\nSupport Group @codexmaniasupport :)", buttons=[Button.url("Channel", url=f"https://t.me/{channel}"), Button.url("Repository", url="https://github.com/xditya/ForceSub")])
